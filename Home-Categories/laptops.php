  ...
  <div class="container justify-content-center align-items-center">
    ...
    <div class="container d-flex justify-content-center align-items-center mt-3 text-dark text-center">
      <div class="row d-flex justify-content-between align-items-center gap-3">
        ...
        <!-- Card 2 -->
        <div class="card col-12 col-sm-3 col-md-3 d-flex justify-content-center align-items-center bg-light " onclick="window.location.href='../Product Pages/Laptops/Acer Laptop.php';">
        ...
        <!-- Card 3 -->
        <div class="card col-12 col-sm-3 col-md-3 d-flex justify-content-center align-items-center bg-light " onclick="window.location.href='../Product Pages/Laptops/Apple Laptop.php';">
    ...
    <div class="container d-flex justify-content-center align-items-center mt-3 text-dark text-center mb-5">
      <div class="row d-flex justify-content-between align-items-center gap-3">
        <!-- Card 4 -->
        <div class="card col-12 col-sm-3 col-md-3 d-flex justify-content-center align-items-center bg-light " onclick="window.location.href='../Product Pages/Laptops/Chrome Book.php';">
          <img src="../assets/Icons/Laptops/Chrome Book laptops/1.jpg" class="card-img-top img-fluid" alt="...">
          <div class="card-body">
        ...
        <!-- Card 5 -->
        <div class="card col-12 col-sm-3 col-md-3 d-flex justify-content-center align-items-center bg-light " onclick="window.location.href='../Product Pages/Laptops/Dell Laptop.php';">
        ...
        <!-- Card 6 -->
        <div class="card col-12 col-sm-3 col-md-3 d-flex justify-content-center align-items-center bg-light " onclick="window.location.href='../Product Pages/Laptops/PM Laptop.php';">
