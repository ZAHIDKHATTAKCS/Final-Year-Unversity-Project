...
<head>
  ...
  <title>Purchase Dell Monitor</title>
  ...
  <link rel="shortcut icon" href="../../assets/Icons/Favicons/Monitor.svg" type="image/x-icon">
</head>
  ...
  <div class="container-fluid d-flex flex-column justify-content-center align-items-center">
    <div class="row d-flex col-12 justify-content-between p-1 mt-2 align-items-center">
      ...
      <div class="card col-sm-10 col-md-5 col-lg-4 ">
        <!-- big img -->
        <img src="../../assets/Icons/LCD/Dell LCD/1.jpg" class="w-100 img-fluid" id="big-img" alt="img">


        <!-- small images -->
        <div class="card-body d-flex justify-content-between">
          <img src="../../assets/Icons/LCD/Dell LCD/2.jpg" class="small-img" alt="...">
          <img src="../../assets/Icons/LCD/Dell LCD/4.jpg" class="small-img " alt="...">
          <img src="../../assets/Icons/LCD/Dell LCD/1.jpg" class="small-img " alt="...">
        </div>
      </div>
      ...
      <div class="text-center col-sm-10 col-md-6 col-lg-6 p-3">
        <h2>Dell Monitor</h2>
        <h4>With Power Cable and VGA/HDMI Cable</h4>
