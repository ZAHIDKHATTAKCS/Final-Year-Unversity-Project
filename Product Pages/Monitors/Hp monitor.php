...
<head>
  ...
  <title>Purchase HP Monitor</title>
  ...
  <div class="container-fluid d-flex flex-column justify-content-center align-items-center">
    <div class="row d-flex col-12 justify-content-between p-1 mt-2 align-items-center">
      ...
      <div class="card col-sm-10 col-md-5 col-lg-4 ">
        <!-- big img -->
        <img src="../../assets/Icons/LCD/HP LCD/1.jpg" class="w-100 img-fluid" id="big-img" alt="img">


        <!-- small images -->
        <div class="card-body d-flex justify-content-between">
          <img src="../../assets/Icons/LCD/HP LCD/2.jpg" class="small-img" alt="...">
          <img src="../../assets/Icons/LCD/HP LCD/3.jpg" class="small-img " alt="...">
          <img src="../../assets/Icons/LCD/HP LCD/1.jpg" class="small-img " alt="...">
        </div>
      </div>
