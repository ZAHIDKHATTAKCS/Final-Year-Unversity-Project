...
<head>
  ...
  <title>Nikon Camera Purchase</title>
  ...
  <link rel="shortcut icon" href="../../assets/Icons/Favicons/Camera.svg" type="image/x-icon">
</head>
  ...
  <div class="container-fluid d-flex flex-column justify-content-center align-items-center">
    <div class="row d-flex col-12 justify-content-between p-1 mt-2 align-items-center">
      ...
      <div class="card col-sm-10 col-md-5 col-lg-4 ">
        <!-- big img -->
        <img src="../../assets/Icons/Cameras/camera3.jpg" class="w-100 img-fluid" id="big-img" alt="img">


        <!-- small images -->
        <div class="card-body d-flex justify-content-between">
          <img src="../../assets/Icons/Cameras/Nikon Camera/3.jpg" class="small-img" alt="...">
          <img src="../../assets/Icons/Cameras/Nikon Camera/2.jpg" class="small-img " alt="...">
          <img src="../../assets/Icons/Cameras/Nikon Camera/4.jpg" class="small-img " alt="...">
          <img src="../../assets/Icons/Cameras/camera3.jpg" class="small-img" alt="img">
        </div>
      </div>
      ...
      <div class="text-center col-sm-10 col-md-6 col-lg-6 p-3">
        <h2>Camera</h2>
        <h4>Nikon Camera with 5 lenses</h4>
