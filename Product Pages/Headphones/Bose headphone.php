...
<head>
  ...
  <title>Purchase Bose Headphone</title>
  ...
  <div class="container-fluid d-flex flex-column justify-content-center align-items-center">
    <div class="row d-flex col-12 justify-content-between p-1 mt-2 align-items-center">
      ...
      <div class="card col-sm-10 col-md-5 col-lg-4 ">
        <!-- big img -->
        <img src="../../assets/Icons/Headphones/Bose Headphones/1.jpg" class="w-100 img-fluid" id="big-img" alt="img">


        <!-- small images -->
        <div class="card-body d-flex justify-content-between">
          <img src="../../assets/Icons/Headphones/Bose Headphones/3.jpg" class="small-img" alt="...">
          <img src="../../assets/Icons/Headphones/Bose Headphones/4.jpg" class="small-img " alt="...">
          <img src="../../assets/Icons/Headphones/Bose Headphones/1.jpg" class="small-img " alt="...">
        </div>
      </div>
