...
<head>
  ...
  <title>Purchase Bluedio Headphone</title>
  ...
  <link rel="shortcut icon" href="../../assets/Icons/Favicons/Headphone.svg" type="image/x-icon">
</head>
  ...
  <div class="container-fluid d-flex flex-column justify-content-center align-items-center">
    <div class="row d-flex col-12 justify-content-between p-1 mt-2 align-items-center">
      ...
      <div class="card col-sm-10 col-md-5 col-lg-4 ">
        <!-- big img -->
        <img src="../../assets/Icons/Headphones/Bluedeo Headphones/1.jpg" class="w-100 img-fluid" id="big-img" alt="img">


        <!-- small images -->
        <div class="card-body d-flex justify-content-between">
          <img src="../../assets/Icons/Headphones/Bluedeo Headphones/2.jpg" class="small-img" alt="...">
      ...
      <div class="text-center col-sm-10 col-md-6 col-lg-6 p-3">
        <h2>BLuedio Headpone</h2>
        <h4>With Box and original Charger</h4>
        ...
        <div class="d-block p-3 d-md-flex ">
          ...
          <div class="d-flex justify-content-between gap-3">
            <!-- Add to Cart Button -->
            <button class="p-2 btn btn-danger rounded-2 ms-2">Add To Cart</button>
            <!-- order Button -->
