...
<head>
  ...
  <title>Pharchase Bludeo Headphones</title>
  ...
  <div class="container-fluid d-flex flex-column justify-content-center align-items-center">
    <div class="row d-flex col-12 justify-content-between p-1 mt-2 align-items-center">
      ...
      <div class="card col-sm-10 col-md-5 col-lg-4 ">
        <!-- big img -->
        <img src="../assets/Icons/Headphones/bludeo bluetooth.jpg" class="w-100 img-fluid" id="big-img" alt="img">


        <!-- small images -->
        <div class="card-body d-flex justify-content-between">
          <img src="../assets/Icons/Headphones/Bluedeo Headphones/1.jpg" class="small-img" alt="...">
          <img src="../assets/Icons/Headphones/Bluedeo Headphones/3.jpg" class="small-img " alt="...">
          <img src="../assets/Icons/Headphones/bludeo bluetooth.jpg" class="small-img " alt="...">
        </div>
      </div>

      <!-- Product Description -->
      <div class="text-center col-sm-10 col-md-6 col-lg-6 p-3">
        <h2>Infinix Mobile</h2>
        <h4>Infinix Hot 12 mobile with orignal Charger </h4>
...
Room      : 128
        ...
        <div class="d-flex p-3">
          <input type="number" class="form-control w-100" name="" id="" placeholder="Enter Quantity" required>

          <!-- Add to Cart Button -->
          <button class="p-2 btn btn-success rounded-2">Add To Cart</button>
        </div>
      </div>
    </div>
    ...
    <div class="container d-flex justify-content-center align-items-center mt-3 text-dark text-center">
      <div class="row d-flex justify-content-between align-items-center gap-3">
        <!-- Card 1 -->
        <div class="card col-12 col-sm-3 col-md-3 d-flex justify-content-center align-items-center bg-light" onclick="window.location.href='Product Pages/HP laptop.php';">
        ...
        <!-- Card 2 -->
        <div class="card col-12 col-sm-3 col-md-3 d-flex justify-content-center align-items-center bg-light " onclick="window.location.href='Single-Pages/single-product2.php';">
        ...
        <!-- Card 3 -->
        <div class="card col-12 col-sm-3 col-md-3 d-flex justify-content-center align-items-center bg-light " onclick="window.location.href='Single-Pages/single-product3.php';">
