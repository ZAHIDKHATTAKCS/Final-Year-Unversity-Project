...
<head>
  ...
  <title>Purchase PM Laptop</title>
  ...
  <div class="container-fluid d-flex flex-column justify-content-center align-items-center">
    <div class="row d-flex col-12 justify-content-between p-1 mt-2 align-items-center">
      ...
      <div class="card col-sm-10 col-md-5 col-lg-4 ">
        <!-- big img -->
        <img src="/assets/Icons/Laptops/PM Laptop/5.jpeg" class="w-100 img-fluid" id="big-img" alt="...">


        <!-- small images -->
        <div class="card-body d-flex justify-content-between">
          <img src="/assets/Icons/Laptops/PM Laptop/1.jpeg" class="small-img" alt="...">
          <img src="/assets/Icons/Laptops/PM Laptop/3.jpeg" class="small-img " alt="...">
          <img src="/assets/Icons/Laptops/PM Laptop/5.jpeg" class="small-img " alt="...">
        </div>
      </div>
      ...
      <div class="text-center col-sm-10 col-md-6 col-lg-6 p-3">
        <h2>PM Laptop</h2>
        <h4>PM Laptop core I 7  12th Generation </h4>
